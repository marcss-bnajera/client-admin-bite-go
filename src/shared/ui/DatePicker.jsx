    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                disabled={disabled}
                className={`w-full flex items-center gap-2 px-4 py-2.5 text-sm border rounded-xl outline-none transition-colors ${
                    disabled
                        ? "bg-[#F5EFE6]/50 text-gray-400 cursor-not-allowed border-[#E8D8C3]"
                        : "bg-[#F5EFE6]/50 hover:border-[#E67E22] focus:border-[#E67E22] cursor-pointer border-[#E8D8C3]"
    ...
    return (
        <div className="flex gap-2">
            <select
                ...
                disabled={disabled}
                className="flex-1 px-4 py-2.5 text-sm border border-[#E8D8C3] rounded-xl focus:border-[#E67E22] outline-none bg-[#F5EFE6]/50 text-[#2B2B2B] transition-colors"
            >
